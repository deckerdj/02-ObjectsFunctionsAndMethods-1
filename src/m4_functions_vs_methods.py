...
def try_methods():
    ...
    ###########################################################################
    new_challenger = rg.SimpleTurtle('turtle')
    new_challenger.pen = rg.Pen('brown', 5)

    new_challenger.forward(150)
    new_challenger.left(90)
    new_challenger.forward(50)
    new_challenger.backward(100)
...
def try_methods_and_functions():
    ...
    ###########################################################################
    manus = rg.SimpleTurtle('turtle')
    manus.pen = rg.Pen('blue', 5)

    manus.backward(150)

    manus.speed = 1
    draw_many_squares(manus, 2, 100, 30)

    manus.speed = 5
    manus.pen.color = 'red'
    draw_many_squares(manus, 10, 50, 15)

    manus.speed = 100
    manus.pen.thickness = 35
    draw_many_squares(manus, 8, 300, 60)

    manus.pen = rg.Pen('black', 3)

    manus.backward(200)

    manus.draw_circle(30)

    manus.draw_square(50)
