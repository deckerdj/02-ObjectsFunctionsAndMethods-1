...
def main():
    ...
    better_draw_circles(rg.Point(100, 50), 2)
    better_draw_circles(rg.Point(-200, 0), 5)
    even_better_draw_circles(rg.Point(200, 50), 10, 10, 'blue', 5)
    even_better_draw_circles(rg.Point(100, 150), 5, 5, 'red', 6)
...
def better_draw_circles(point, radii):
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(15 * (k + radii))  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, radii, nu, co, th):
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(nu * (k + radii))  # Radius 15, 30, 45, 60, ...
